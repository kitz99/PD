...
let rec infertype m = function
  | Int (n,_) -> TInt
  | Bool (b,_) -> TBool
  | Op(e1,Plus,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  | Op(e1,Min,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  | Op(e1,Mul,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
  | Op(e1,Div,e2,_) -> (match (infertype m e1, infertype m e2) with
     | (TInt, TInt) -> TInt
     | (TInt, t) -> raise (TypeError (e2, TInt, t))
     | (t,_) -> raise (TypeError (e1, TInt, t)))
